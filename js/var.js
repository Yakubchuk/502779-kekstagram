...
(function () {
  window.var = {
    SETTINGS: document.querySelector('.upload-overlay'),
    IMG_PREV: document.querySelector('.effect-image-preview'),
    RUNNER: document.querySelector('.upload-effect-level-pin'),
